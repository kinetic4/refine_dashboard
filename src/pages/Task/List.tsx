...
import { ProjectCardMemo, ProjectCard, ProjectCardSkeleton } from '@/component/tasks/kanban/card'
import { KanbanColumn, KanbanColumnSkeleton } from '@/component/tasks/kanban/column'
...
const List = ({ children } : React.PropsWithChildren) => {
  ...
  const taskStages = React.useMemo(() => {
    ...
    const unassignedStage = tasks.data.filter((task) => tasks.stageId === null)
